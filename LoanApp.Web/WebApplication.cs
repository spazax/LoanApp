...
namespace LoanApp.Web {
    ...
    public partial class LoanAppAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private LoanApp.Module.LoanAppModule module3;
        private LoanApp.Module.Web.LoanAppAspNetModule module4;
        ...
        static LoanAppAspNetApplication() {
        ...
        #endregion
        public LoanAppAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void LoanAppAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new LoanApp.Module.LoanAppModule();
            this.module4 = new LoanApp.Module.Web.LoanAppAspNetModule();
            ...
            // 
            // LoanAppAspNetApplication
            // 
            this.ApplicationName = "LoanApp";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.LoanAppAspNetApplication_DatabaseVersionMismatch);
